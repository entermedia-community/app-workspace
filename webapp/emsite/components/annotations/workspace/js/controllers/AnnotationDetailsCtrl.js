...
Workspace.controller('AnnotationDetailsCtrl', [
  '$rootScope', '$scope', '$stateParams', '$timeout', 'annotationService', 'fabricJsService', 'annotationSocket', 'collectionAssetData', function($rootScope, $scope, $stateParams, $timeout, annotationService, fabricJsService, annotationSocket, collectionAssetData) {
    var commentPin, fromExistingState, getSelf, metaUser, readyToComment, toolkit;
    ...
    */
    ...
    $scope.$on('removeAnnotation', function(e, id) {
      var clientCopy;
